...
Размер задаётся свойством `size`, например, `size="small"`[^1].<br>
Пользовательская высота задаётся в свойстве `vertSize`, например, `vertSize="40"`.<br>
...
:star: Следует огранивать ширину очень длинных кнопок в больших окнах или помещать их рядом с другими элементами.<br>
