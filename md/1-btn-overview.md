...
В исключительном случае для кнопки с иконкой или бейджем без текста следует как минимум задать атрибут <b>aria-label</b> с кратким описанием для обработки скринридером — `Уточнить детали у дизайнера макета и разработчика`.
