...
Кнопки имеют форму прямоугольника с закругленными углами (за исключением [типа](./2-btn-types.md) `borderless`), текст и иконка или бейдж слева или справа от текста.<br>Ширина кнопки определяется количеством текста и фиксированными отступами.<br>
...
<details>
  <summary>Кнопки с текстои и иконкой или бейджем </summary><br>
